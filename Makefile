...
OBJS=uart.o pins.o digio.o pwm.o encoder.o beth_joint_internal.o beth_joint.o beth_globals.o timer.o beth_drive_internal.o beth_drive.o

# put here the additional header files needed for compilation
HEADERS=uart.h pins.h digio.h pwm.h encoder.h beth_packets.h beth_joint.h beth_joint_internal.h beth_globals.h timer.h beth_drive_internal.h beth_drive.h
