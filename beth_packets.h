...
#define ID_MOTOR1_CONTROL_PACKET 0 
#define ID_MOTOR1_STATUS_PACKET 1
#define ID_MOTOR1_PARAMS_PACKET 2
#define ID_MOTOR2_CONTROL_PACKET 3 
#define ID_MOTOR2_STATUS_PACKET 4
#define ID_MOTOR2_PARAMS_PACKET 5
#define ID_SYSTEM_STATUS_PACKET 6
#define DIFFERENTIAL_DRIVE_STATUS_PACKET 7
#define DIFFERENTIAL_DRIVE_PARAMS_PACKET 8
#define DIFFERENTIAL_DRIVE_CONTROL_PACKET 9
